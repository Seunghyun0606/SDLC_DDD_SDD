...
> Primary Authority: `sdlc/config/contract-authority.yaml` → `overlay_schema` / `project_decisions` / `provider_runtime`
...
Validation/Experiment 문서는 검증 이력이며 Runtime Authority가 아니다.

...
| 입력 수준 | 기대 결과 | 금지되는 과장 |
|---|---|---|
| 프로젝트 목적 + 요구 원문만 있음 | RQ/FR/AC 후보, 6W 업무 시나리오 후보, 확인 질문 | 상세 DTO/Table/API/화면을 확정값으로 생성 |
| Actor/프로세스/데이터 의미까지 있음 | Functional Design 구체화 | 미정 Architecture/UI를 사실처럼 표현 |
...
### DESIGN_READY
6W Scenario, Actor, 핵심 Process, 주요 Data Concept, 핵심 예외/제약이 최소 Candidate 수준으로 정리되어 있고, 확인이 필요한 부분이 명시되어 있다.

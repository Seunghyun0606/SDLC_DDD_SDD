...
>
> **사용자는 이 Template의 빈칸을 직접 채우지 않습니다.** Agent가 먼저 초안을 만들고 필요한 질문만 요청합니다. 수정이 필요하면 `이 문서의 [BLOCK:WM-MAPPING]을 ...로 바꿔줘`처럼 Block을 지정합니다.

**Block ID:** `WM-SUMMARY`, `WM-UNIT`, `WM-MAPPING`, `WM-AC-TEST`, `WM-OPEN`, `WM-NEXT`

...
public class FlexibleWorkPlanService {
    ...
    public Object initializeFirstPlan(String employeeId, String periodId) {
        Object current = mapper.selectPlan(employeeId, periodId);
        if (current != null) return current;
        Object defaults = mapper.selectDefaultSchedule(employeeId, periodId);
        mapper.upsertPlan(employeeId, periodId, defaults);
        return mapper.selectPlan(employeeId, periodId);
    }
}
